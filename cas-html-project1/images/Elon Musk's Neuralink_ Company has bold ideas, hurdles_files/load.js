...
if (!_tb_dis) {
    var pm_ppy = "nbcuniversal-cnbc-makeit";
    ...
    var _pmpmk = pm_ppy + '/pmk-201827005.3.js';
    var _pmasync = true;
    ...
    'sx': '//h2[contains(@class,"cnbc")]/a',
    'opd': ["section"]
};

_tb_vpx = [{
    xpath: "//div[contains(@class, 'inline-player')]",
    attr: "div"
}];
...
_tb_ext_xp = {
    'facebook': [{
        'xpath': '//div[contains(@class, "social-media")]//i[contains(@class, "facebook")]',
        'attr': 'div'
    }]
};/** Generated CJS end **/ 
}